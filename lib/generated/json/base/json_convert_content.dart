...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case UserInfoEntity:
			...
			return secretEntityFromJson(data as SecretEntity, json) as T;			case OrderDetailData:
			...
			return expressDataEntityFromJson(data as ExpressData, json) as T;			case ResultData:
			return resultDataFromJson(data as ResultData, json) as T;			case OrderData:
			return orderDataFromJson(data as OrderData, json) as T;			case OrderOrderFlag:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case UserInfoEntity:
			...
			return secretEntityToJson(data as SecretEntity);			case OrderDetailData:
			...
			return expressDataEntityToJson(data as ExpressData);			case ResultData:
			return resultDataToJson(data as ResultData);			case OrderData:
			return orderDataToJson(data as OrderData);			case OrderOrderFlag:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'UserInfoEntity':
			...
			return SecretEntity().fromJson(json);			case 'OrderDetailData':
			...
			return OrderDetailOrderSalesReturn().fromJson(json);			case 'ExpressDataEntity':
			return ExpressData().fromJson(json);			case 'ResultData':
			return ResultData().fromJson(json);			case 'OrderData':
			return OrderData().fromJson(json);			case 'OrderOrderFlag':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'UserInfoEntity':
			...
			return List<SecretEntity>();			case 'OrderDetailData':
			...
			return List<OrderDetailOrderSalesReturn>();			case 'ExpressDataEntity':
			return List<ExpressData>();			case 'ResultData':
			return List<ResultData>();			case 'OrderData':
			return List<OrderData>();			case 'OrderOrderFlag':
