...
import 'package:scan/generated/json/code_bean_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case CodeBeanEntity:
			return codeBeanEntityFromJson(data as CodeBeanEntity, json) as T;			case CodeBeanData:
			return codeBeanDataFromJson(data as CodeBeanData, json) as T;			case ResultData:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case CodeBeanEntity:
			...
			return codeBeanDataToJson(data as CodeBeanData);			case ResultData:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'CodeBeanEntity':
			...
			return CodeBeanData().fromJson(json);			case 'ResultData':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'CodeBeanEntity':
			...
			return List<CodeBeanData>();			case 'ResultData':
