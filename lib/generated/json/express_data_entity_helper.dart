...
expressDataEntityFromJson(ExpressData data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['consignmentCompanyId'] != null) {
		data.consignmentCompanyId = json['consignmentCompanyId']?.toInt();
	}
...
Map<String, dynamic> expressDataEntityToJson(ExpressData entity) {
